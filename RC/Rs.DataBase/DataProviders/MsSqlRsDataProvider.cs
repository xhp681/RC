...
{
    public partial class MsSqlRsDataProvider : BaseDataProvider, IRsDataProvider
    {
        ...
        /// </summary>
        protected override IDataProvider LinqToDbDataProvider => SqlServerTools.GetDataProvider(SqlServerVersion.v2017, SqlServerProvider.SystemDataSqlClient);
