...
namespace Rs.Config
{
    public class RsEngine:IEngine
    {
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var startupConfigurations = _typeFinder.FindClassesOfType<IRsStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IRsStartup)Activator.CreateInstance(startup))
        ...
        public void ConfigureRequestPipeline(IApplicationBuilder application)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IRsStartup>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new RsException("Unknown dependency");
                        return service;
                    });
            ...
            throw new RsException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
    }
}
