...
namespace Rs.Common
{
    public class Utils
    {
        ...
        /// </summary>
        public static IRsFileProvider DefaultFileProvider { get; set; }
        /// <summary>
        /// 系统绝对目录
        /// </summary>
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new RsException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new RsException($"No property '{propertyName}' found on the instance of type '{instanceType}'.");
            if (!pi.CanWrite)
                throw new RsException($"The property '{propertyName}' on the instance of type '{instanceType}' does not have a setter.");
