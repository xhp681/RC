...
namespace Rs.Common
{
    public class RsFileProvider : PhysicalFileProvider, IRsFileProvider
    {
        protected string WebRootPath { get; }
        /// <summary>
        /// Initializes a new instance of a RsFileProvider
        /// </summary>
        /// <param name="webHostEnvironment">Hosting environment</param>
        public RsFileProvider(IWebHostEnvironment webHostEnvironment)
