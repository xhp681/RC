...
namespace Rs.Common
{
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IRsFileProvider _fileProvider;
        public AppDomainTypeFinder(IRsFileProvider fileProvider = null)
        {
            _fileProvider = fileProvider ?? Utils.DefaultFileProvider;
        }
