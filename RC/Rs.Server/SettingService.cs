...
namespace Rs.Server
{
    public partial class SettingService:ISettingService
    {
        ...
        {
            return await _staticCacheManager.GetAsync(RsConfigurationDefaults.SettingsAllAsDictionaryCacheKey, async () =>
            {
            ...
            int storeId = 0, bool loadSharedValueIfNotFound = false)
        {
            ...
            return setting != null ? Utils.To<T>(setting.Value) : defaultValue;
        }
        ...
        {
            await _staticCacheManager.RemoveByPrefixAsync(RsEntityCacheDefaults<Setting>.Prefix);
        }
