...
namespace Rs.Server
{
    public partial class TaskThread: IDisposable
    {
        ...
        static TaskThread()
        {
            _scheduleTaskUrl = $"{EngineContext.Current.Resolve<IStoreContext>().GetCurrentStoreAsync().Result.Url}{RsTaskDefaults.ScheduleTaskPath}";
        ...
        private async System.Threading.Tasks.Task RunAsync()
        {
            ...
            foreach (var taskName in _tasks.Keys)
            {
                ...
                try
                {
                    ...
                    client = EngineContext.Current.Resolve<IHttpClientFactory>().CreateClient(RsHttpDefaults.DefaultHttpClient);
