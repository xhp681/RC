...
namespace Rs.Server.Catalog
{
    public partial class ReviewTypeService : IReviewTypeService
    {
        ...
        public async Task<IList<ProductReviewReviewTypeMapping>> GetProductReviewReviewTypeMappingsByProductReviewIdAsync(
            int productReviewId)
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(RsCatalogDefaults.ProductReviewTypeMappingByReviewTypeCacheKey, productReviewId);
