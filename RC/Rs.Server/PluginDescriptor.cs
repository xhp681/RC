...
namespace Rs.Server
{
    public partial class PluginDescriptor : PluginDescriptorBaseInfo, IDescriptor, IComparable<PluginDescriptor>
    {
        ...
        /// </summary>
        [JsonPropertyName("LimitedToCustomerRoles")]
        ...
        /// </summary>
        [JsonPropertyName("DependsOnSystemNames")]
        ...
        public static PluginDescriptor GetPluginDescriptorFromText(string text)
        {
            ...
            var descriptor =JsonSerializer.Deserialize<PluginDescriptor>(text);
        ...
        {
            var fileProvider = EngineContext.Current.Resolve<IRsFileProvider>();
            ...
            var filePath = fileProvider.Combine(fileProvider.GetDirectoryName(OriginalAssemblyFile), RsPluginDefaults.DescriptionFileName);
