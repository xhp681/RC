...
{
    public static partial class RsPluginDefaults
    {
        /// <summary>
        ...
        /// </remarks>
        public static CacheKey AdminNavigationPluginsCacheKey => new CacheKey("Rs.plugins.adminnavigation.{0}", AdminNavigationPluginsPrefix);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string AdminNavigationPluginsPrefix => "Rs.plugins.adminnavigation.";
    }
}
