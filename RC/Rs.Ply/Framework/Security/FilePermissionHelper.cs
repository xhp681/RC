...
namespace Rs.Ply.Framework.Security
{
    public static class FilePermissionHelper
    {
        ...
        public static IEnumerable<string> GetFilesWrite()
        {
            ...
            {
                fileProvider.MapPath(RsPluginDefaults.PluginsInfoFilePath),
                fileProvider.MapPath(DataSettingsDefaults.FilePath),
                fileProvider.MapPath(RsConfigurationDefaults.AppSettingsFilePath)
            };
        }
    }
}
