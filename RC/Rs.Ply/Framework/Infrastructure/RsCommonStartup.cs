...
{
    public class RsCommonStartup: IRsStartup
    {
        /// <summary>
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddRouting(options =>
            {
                ...
                options.ConstraintMap[RsPathRouteDefaults.LanguageParameterTransformer] = typeof(LanguageParameterTransformer);
            });
        }
        ...
        public void Configure(IApplicationBuilder application)
        {
            ...
            application.UseRsResponseCompression();

            //use static files feature
            application.UseRsStaticFiles();
            ...
            application.UseRsRequestLocalization();
        }
